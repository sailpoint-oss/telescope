...
export const StringSchema30 = z
	.object({
		type: z
			...
			.describe("Must be 'string' for string schemas.")
			.optional(),
...
export const NumberSchema30 = z
	.object({
		type: z
			...
			.describe("Must be 'number' for floating-point number schemas.")
			.optional(),
		...
		minimum: z
			...
			.describe(
				"Minimum value (inclusive unless exclusiveMinimum is true in 3.0).",
			)
			.optional(),
		maximum: z
			.number()
			...
			.describe(
				"Maximum value (inclusive unless exclusiveMaximum is true in 3.0).",
			)
			.optional(),
		exclusiveMinimum: z
			.boolean()
			...
			.describe(
				"OpenAPI 3.0: If true, value must be > minimum, not >= minimum.",
			)
			.optional(),
		exclusiveMaximum: z
			.boolean()
			...
			.describe(
				"OpenAPI 3.0: If true, value must be < maximum, not <= maximum.",
			)
			.optional(),
		...baseSchemaFields30,
		...compositionFields30,
...
export const IntegerSchema30 = z
	.object({
		type: z
			.literal("integer")
			.meta({
			...
			.describe("Must be 'integer' for whole number schemas.")
			.optional(),
		...
		maximum: z
			...
			.meta({
				title: "maximum",
				examples: [100, 2147483647, 922337203685477],
			})
			.describe(
				"Maximum value (inclusive unless exclusiveMaximum is true in 3.0).",
			)
		...
		exclusiveMinimum: z
			...
			.describe("OpenAPI 3.0: If true, value must be > minimum.")
			.optional(),
		exclusiveMaximum: z
			.boolean()
			.meta({
			...
			.describe("OpenAPI 3.0: If true, value must be < maximum.")
			.optional(),
		...baseSchemaFields30,
		...compositionFields30,
	})
...
export const BooleanSchema30 = z
	.object({
		type: z.literal("boolean").meta({ title: "type" }).optional(),
		...baseSchemaFields30,
		...compositionFields30,
	})
...
export const ArraySchema30 = z
	.object({
		type: z.literal("array").meta({ title: "type" }).optional(),
...
export const ObjectSchema30 = z
	.object({
		type: z.literal("object").meta({ title: "type" }).optional(),
		properties: z
...
export const Components30Schema = z
	.object({
		schemas: z
...
export const OpenAPI30Schema = z
	.object({
		openapi: z
			.string()
			.regex(/^3\.0\.\d+$/)
