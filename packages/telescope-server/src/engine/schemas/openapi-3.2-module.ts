...
export const Info32Schema = z
	.object({
		...
		termsOfService: z
			...
			.optional(),
		contact: Contact32Schema.optional().meta({ title: "contact" }),
		license: License32Schema.optional().meta({ title: "license" }),
	})
	.meta({
		title: "Info",
		description:
...
export const OAuthFlows32Schema = z
	.object({
		implicit: OAuthFlow32Schema.optional().meta({ title: "implicit" }),
		password: OAuthFlow32Schema.optional().meta({ title: "password" }),
...
const baseSchemaFields32 = {
	...
	example: z
		...
		.describe(
			"An example value for this schema. OpenAPI 3.2+ prefers 'examples' (plural) but 'example' is still valid.",
		)
		.optional(),
	examples: z
		.array(z.unknown())
	...
	xml: XML32Schema.optional().meta({ title: "xml" }),
	externalDocs: ExternalDocumentation32Schema.meta({
		title: "externalDocs",
	}).optional(),
	readOnly: z
...
const LinkObjectSchema32 = z
	.object({
		...
		description: z
			...
			.optional(),
		server: Server32Schema.optional().meta({ title: "server" }),
	})
	.meta({
		title: "Link",
		description:
...
const HeaderObjectSchema32 = z
	.object({
		...
		schema: SchemaObject32Schema.optional().meta({ title: "schema" }),
...
export const Operation32Schema = z
	.object({
		...
		parameters: z
			...
			.optional(),
		requestBody: RequestBody32Schema.optional().meta({ title: "requestBody" }),
		...
		security: z
			...
			.optional(),
		servers: z.array(Server32Schema).optional().meta({ title: "servers" }),
		externalDocs: ExternalDocumentation32Schema.meta({
			title: "externalDocs",
		}).optional(),
	})
...
export const PathItem32Schema: z.ZodTypeAny = z
	.object({
		...
		summary: z.string().optional().meta({ title: "summary" }),
		description: z.string().optional().meta({ title: "description" }),
		get: Operation32Schema.optional().meta({ title: "get" }),
		put: Operation32Schema.optional().meta({ title: "put" }),
		post: Operation32Schema.optional().meta({ title: "post" }),
		delete: Operation32Schema.optional().meta({ title: "delete" }),
		options: Operation32Schema.optional().meta({ title: "options" }),
		head: Operation32Schema.optional().meta({ title: "head" }),
		patch: Operation32Schema.optional().meta({ title: "patch" }),
		trace: Operation32Schema.optional().meta({ title: "trace" }),
...
export const Callback32Schema: z.ZodTypeAny = z
	.union([
		Reference32Schema,
		z.record(z.string(), PathItem32Schema).meta({
			title: "Callback",
			description:
...
export const Components32Schema: z.ZodTypeAny = z
	.object({
		schemas: z
