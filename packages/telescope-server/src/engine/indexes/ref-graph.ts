 ...
 * @example
 * ```typescript
 * import { buildRefGraph, findRefUris, makeNode } from "telescope-server";
 *
 * // Build the graph
...
import type { GraphNode, RefGraph, Resolver } from "./graph-types.js";
import type { RootResolver } from "./types.js";
