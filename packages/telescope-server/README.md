...
```bash
bun packages/telescope-server/src/server.ts
```
...
4. Watch the **telescope Language Server** output channel for logs
...
# Specific test file
bun test packages/telescope-server/tests/engine/rules.test.ts
```
...
- [telescope Client](../telescope-client/README.md)
