 ...
 * @example
 * ```typescript
 * import { detectVersionFromContent } from "aperture-server";
 *
	...
	if (tracker.v31.length > 0) {
		...
		if (tracker.v30.length > 0) {
			return {
				version: "3.1",
				confidence: "medium",
				indicators: [...tracker.v31, `(conflicts with 3.0: ${tracker.v30.join(", ")})`],
			};
		}
		return {
			version: "3.1",
 ...
 */
export function isVersion(hint: VersionHint, version: DetectedVersion): boolean {
