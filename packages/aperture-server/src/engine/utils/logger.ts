 ...
 * @example
 * ```typescript
 * import { Logger, consoleLogger, noopLogger } from "aperture-server";
 *
 * // Use console logger
 ...
 * @example
 * ```typescript
 * import { noopLogger } from "aperture-server";
 *
 ...
 * @example
 * ```typescript
 * import { consoleLogger } from "aperture-server";
 *
 ...
 *
 * This adapter converts the DiagnosticsLogger interface (used by ApertureVolarContext)
 ...
 * @example
 * ```typescript
 * import { createLoggerFromDiagnosticsLogger } from "aperture-server";
 *
