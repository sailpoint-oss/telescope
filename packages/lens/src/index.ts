 ...
 * );
 */
// biome-ignore lint/suspicious/noExplicitAny: ZodSchema type is complex, any is sufficient here
export function defineSchema<T extends any>(schema: T): T {
  return schema;
}

// Re-export all engine functionality
// Execution
export { runEngine, createRuleContext } from "./core/runner.js";
...
export { findNodeByPointer, getValueAtPointer as getValueAtPointerIR, irLocToRange, irPointerToRange } from "./ir/context.js";
...
// Utilities
export { identifyDocumentType, isRootDocument, isPartialDocument, type DocumentType } from "shared/document-type-utils";
export { getValueAtPointer, joinPointer, splitPointer, encodePointerSegment, decodePointerSegment } from "shared/pointer-utils";
...
export type { GenericRunOptions, GenericRunResult } from "./core/generic-runner.js";
