/**
 * JSON Pointer utilities for navigating and manipulating JSON Pointer strings.
 * Centralized in shared package to avoid circular dependencies.
 */
 ...
 * For IR documents, use getValueAtPointer from lens/ir/context.ts instead.
 */
